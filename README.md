...
# ║  ╚══════╝╚═╝╚══════╝╚═╝╚═╝     ╚═╝  ╚═╝ ╚═════╝ ╚══════╝ ║
# ║                                                          ║
# ║     v1.6.2 — AI-First CLI OS for Old Hardware            ║
...
lsblk
sudo dd if=sid-1.6.2-live-x86_64.iso of=/dev/sdb bs=4M status=progress
```
...
```
SID OS v1.6.2 — Super Intelligent Distro
